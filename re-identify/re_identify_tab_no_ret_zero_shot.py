...
raws = [json.loads(line) for line in open("../datasets/Anonymized_TAB_with_all_plus_gens_rets.jsonl", "r")]
...
with open("results_tab_no_ret_zero_shot_run_3.txt", "w") as f:
...
with open("../datasets/Re-identified_TAB_No_Ret_Zero_Shot.jsonl", "w") as fo:
