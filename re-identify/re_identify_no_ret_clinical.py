...
raws = [json.loads(line) for line in open("../datasets/Anonymized_Clinical_notes_with_general_rets.jsonl", "r")]

# searcher = LuceneSearcher('../indexes_all_files')
...
with open("results_clinical_no_ret_run_3.txt", "w") as f:
...
with open("../data_biographies/Re-identified_clinical_no_ret.jsonl", "w") as fo:
