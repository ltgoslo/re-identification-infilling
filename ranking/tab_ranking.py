...
with open("../datasets/tab_all_mistral.pkl", "rb") as f:
    re_id_articles = pickle.load(f)

with open("../datasets/tab_names.pkl", "rb") as f:
    dev_labels = pickle.load(f)

with open("../datasets/tab_masked.pkl", "rb") as f:
...
dev_dataset_neg = NegativeReducedDataset(masked_articles, dev_labels, num_negative_labels=len(dev_labels)-1)
...
dev_dataset_neg = NegativeReducedDataset(re_id_articles, dev_labels, num_negative_labels=len(dev_labels)-1)
